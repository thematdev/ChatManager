...
public class BukkitYamlConfigurationNode implements YamlConfigurationNode{

	private final FileConfiguration configuration;
    private final String path;

    BukkitYamlConfigurationNode(FileConfiguration configuration, String path) {
    ...
    public YamlConfigurationNode getNode(String path) {
        if (configuration.contains(this.path + "." + path)
            ...
            return new BukkitYamlConfigurationNode(configuration, this.path + "." + path);
    ...
    public List<YamlConfigurationNode> getChildNodes() {
        ...
        return section.getKeys(false).stream()
                .map(key -> new BukkitYamlConfigurationNode(configuration, path + "." + key)).collect(Collectors.toList());
    }
